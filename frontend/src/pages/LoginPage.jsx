      ...
      <div className="flex items-center justify-center py-20 px-4">
        <div className="card w-full max-w-md bg-base-100 shadow-2xl">
          <div className="card-body">
            ...
            <div className="divider text-xs uppercase text-base-content/50 my-6">Or continue with</div>

            <div className="grid grid-cols-2 gap-3">
              <a
                href={`${import.meta.env.VITE_API_URL || "http://localhost:3000/api"}/auth/google`}
                className="btn btn-outline border-base-300 hover:bg-base-200 flex items-center justify-center gap-2 font-normal transition-colors"
              >
